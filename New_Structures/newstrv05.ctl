...
(define-param cx1 (* d (cos theta) ))
(define-param cy1 (* d (sin theta) ))
(define-param cx2 (* d (cos (+ (- (/ pi 3)) theta) )))
(define-param cy2 (* d (sin (+ (- (/ pi 3)) theta) )))
(define-param cx3 (* d (cos (+ (- (/ (* 2 pi) 3)) theta) )))
(define-param cy3 (* d (sin (+ (- (/ (* 2 pi) 3)) theta) )))
(define-param cx4 (* d (cos (+ (- pi) theta) )))
(define-param cy4 (* d (sin (+ (- pi) theta) )))
(define-param cx5 (* d (cos (+ (/ (* 2 pi) 3) theta) )))
(define-param cy5 (* d (sin (+ (/ (* 2 pi) 3) theta) )))
(define-param cx6 (* d (cos (+ (/ pi 3) theta) )))
(define-param cy6 (* d (sin (+ (/ pi 3) theta) )))
...
(set! geometry
	...
	(make cylinder (material Si)
		(center cx6 cy6 0 ) (radius r) (height h) )))
