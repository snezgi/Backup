...
(define-param cx1 (* (/ d (sqrt 2)) (cos (+ (- (/ pi 4)) theta) )))
(define-param cy1 (* (/ d (sqrt 2)) (sin (+ (- (/ pi 4)) theta) )))
(define-param cx2 (* (/ d (sqrt 2)) (cos (+ (- (/ (* 3 pi) 4)) theta) )))
(define-param cy2 (* (/ d (sqrt 2)) (sin (+ (- (/ (* 3 pi) 4)) theta) )))
(define-param cx3 (* (/ d (sqrt 2)) (cos (+ (/ (* 3 pi) 4) theta) )))
(define-param cy3 (* (/ d (sqrt 2)) (sin (+ (/ (* 3 pi) 4) theta) )))
(define-param cx4 (* (/ d (sqrt 2)) (cos (+ (/ pi 4) theta) )))
(define-param cy4 (* (/ d (sqrt 2)) (sin (+ (/ pi 4) theta) )))
