...
(define-param cx1 (* (/ d (sqrt 3)) (cos (+ (- (/ pi 6)) theta) )))
(define-param cy1 (* (/ d (sqrt 3)) (sin (+ (- (/ pi 6)) theta) )))
(define-param cx2 (* (/ d (sqrt 3)) (cos (+ (- (/ (* 5 pi) 6)) theta) )))
(define-param cy2 (* (/ d (sqrt 3)) (sin (+ (- (/ (* 5 pi) 6)) theta) )))
(define-param cx3 (* (/ d (sqrt 3)) (cos (+ (/ pi 2) theta) )))
(define-param cy3 (* (/ d (sqrt 3)) (sin (+ (/ pi 2) theta) )))
